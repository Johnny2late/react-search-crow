...
function Example() {
  ...
  useEffect(() => {
    console.log(selectItem) // { id: 4, value: 'text 4', price: '5$' }
  ...
  const itemsNumbers = [1, 2, 3, 4, 33, [333, [3]]]
  const itemsStrings = ['1', 'text 1', 'text', 'text2', 'text 3', ['tex1']]

  const separator = ' - '

  onSearchCrow(itemsNumbers, '3') // [3, 33, 333, 3]
  onSearchCrow(itemsStrings, '1') // ['1', 'text 1', 'text 1']
